...
bool SwapChainSupportDetails::isSwapChainSuitable() {
...
VkExtent2D SwapChainSupportDetails::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities, const uint32_t width, const uint32_t height) {
